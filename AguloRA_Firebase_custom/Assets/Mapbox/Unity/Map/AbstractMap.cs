...
namespace Mapbox.Unity.Map
{
	...
	public class AbstractMap : MonoBehaviour, IMap
	{
		...
		{
			Vector2d v = new Vector2d(28.185979342838800, -17.194736627318500);
			_initializeOnStart = false;
			if (_options == null)
			{
				_options = new MapOptions();
			}
			_options.locationOptions.latitudeLongitude = String.Format(CultureInfo.InvariantCulture, "{0},{1}", v.x, v.y);
